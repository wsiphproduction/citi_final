		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item"><a href="{{ route('branch-group.index') }}">Branch Groups</a></li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">Branch Groups</h4>
		</div>
                        ...
                        <tr>
                            ...
                            <td> 
                                <nav class="nav table-options">
                                    <a class="nav-link p-0 pl-2" href="{{ route('branch-group.show', $bran->id) }}" title="View Group">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                    </a>   
                                    @if(auth()->user()->position != 'Audit' && auth()->user()->position != 'audit')
                                    <a class="nav-link p-0 pl-2" href="{{ route('branch-group.edit', $bran->id) }}" title="Edit Group">
