...
@section('content')
	...
	<div class="d-flex flex-column flex-lg-row justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
		...
		<div class="d-md-block mt-4 mt-lg-0">
        	<a class="btn btn-sm pd-x-15 btn-primary btn-uppercase" href="{{ route('requestor.ts.create') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($slip->status == 'saved' || \Str::contains($slip->status , 'disapproved' ))
                                    <a class="nav-link p-0 pl-2" href="{{ route('requestor.ts.edit', $slip->id) }}" title="Edit Request">
