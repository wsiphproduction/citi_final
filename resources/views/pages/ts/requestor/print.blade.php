...
@section('content')
	...
	<div style="width: 90%; display: block; margin: 0 auto; margin-top: 50px;">
		...
		<div class="row">
			...
			<table class="col-lg-12">
				...
				<tr>
					...
					<td width="20%"> <p> Temporary Slip No. </p></td>
					<td width="40%" style="border-bottom: 1px solid #000;"> <p> {{ $ts->ts_no }} </p></td>
				...
				<tr>
					...
					<td width="20%"> <p> Account Name. </p></td>
					<td width="40%" style="border-bottom: 1px solid #000;"> <p> {{ $ts->account_name }} </p></td>
