            ...
            <table id="example1" class="table">
                ...
                <tbody>                    
                    @forelse( $temporary_slips as $slip )
                        <tr>
                            <td><input type="checkbox" data-id="{{ $slip->id }}" class="submittedData" @if($slip->status != 'submitted') disabled @endif ></td>
...
@section('pagejs')
    ...
    <script type="text/javascript">
        ...
        function get_next() {
            ...
            if (!_ts[_i]) {
                $('#pcv_message').text("TS No " + JSON.stringify(_approve_ts) + " is successfully approved");
            ...
            $.ajax({
                ...
                url     : "{!! env('APP_URL') !!}/ts/approver/approve/"+_ts[_i] ,
                method  : 'PUT' ,
                ...
                success : function (res) {
                    ...
                    if(res.need_code) {
                        ...
                        $('#pcv_id').val(res.ts_id);
                        $('#pcvInputApprovalCode').modal({
                            backdrop : 'static' ,
                            show : true
                        });

                        _approve_ts.push(res.ts_no);
        ...
        $(document).on('click', '#btn_approval_code', function(e) {
            ...
            $.ajax({
                ...
                url     : "{!! env('APP_URL') !!}/ts/approver/approve-with-code/"+$('#pcv_id').val(),
                method  : 'PUT' ,
                async   : false ,
                data    : { 
                    _token  : "{!! csrf_token() !!}" ,
