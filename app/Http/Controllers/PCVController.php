...
class PCVController extends Controller
{
    ...
    public function index() {
        ...
        return view('pages.pcv.index', compact('pcvs'));
    ...
    public function show($pcv) {
        ...
        return view('pages.pcv.show', compact('pcv'));
    ...
    public function create() {
        ...
        return view('pages.pcv.create', compact('accounts'));
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('pcv.index')->with('success','PCV has been created!');
